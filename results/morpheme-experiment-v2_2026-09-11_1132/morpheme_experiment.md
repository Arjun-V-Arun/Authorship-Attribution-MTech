...
------------------------------------------------------------------------------
  ...
  at the smallest vocabulary, segmentation cuts types by 98.2% and lifts top-300 coverage 28.7% -> 62.0%
  (the sweep above matters more than any single row: coverage rises
   monotonically as the unit shrinks)
...
------------------------------------------------------------------------------
  ...
  Delta (300), grapheme-protected    macro-F1=0.838 (+/-0.024)
...
------------------------------------------------------------------------------
  ...
  at the smallest vocabulary, segmentation cuts types by 99.1% and lifts top-300 coverage 21.4% -> 63.7%
  (the sweep above matters more than any single row: coverage rises
   monotonically as the unit shrinks)
...
------------------------------------------------------------------------------
  ...
  Delta (300), grapheme-protected    macro-F1=0.772 (+/-0.011)
